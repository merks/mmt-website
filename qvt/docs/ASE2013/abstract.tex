...
%
% $Id: abstract.tex 5392 2013-05-09 16:07:37Z hhoyos@CS.YORK.AC.UK $
%=======================================================================
\begin{abstract}
...
%A  program-to-program transformation can then be implemented to support the complete set of languages.
